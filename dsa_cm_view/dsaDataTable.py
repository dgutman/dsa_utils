...
def gen_DSA_DataTable(df, summaryColumns=[], columns_to_ignore=[]):
    ...
    table = html.Div([
        dash_table.DataTable(
            ...
            columns=[
                {"name": i, "id": i, "deletable": False, "selectable": True} for i in df.columns if i not in columns_to_ignore
            ],
